...
export default function Cart() {
    ...
    return (
      <div className=' w-[85%] mx-auto  py-20'>
        <div className='flex justify-center items-center'>
          <Link to={'/home'} className='py-20 shadow-lg w-3/4 flex flex-col  items-center'>
            <i className="ms-2 fa-solid fa-cart-shopping text-green-700 text-9xl"></i>
            <p className='pt-5 text-center text-lg font-semibold text-green-700'>
  ...
  return <>
    ...
    <div className=' w-[85%] mx-auto  '>
      ...
      <div className='cart flex lg:flex-row sm:flex-col-reverse'>
        <div className='lg:w-3/4 py-5 shadow-lg '>
          {allCartProducts.map(function (product, idx) {
            return (
              <div key={idx} className="border-b-1 p-3">
        ...
        <div className='lg:block lg:w-1/4 h-[200px] mx-10 bg-gray-100 p-5 rounded-lg shadow-lg'>
          ...
          <h6 className='md:text-base border-b border-gray-400 py-3'>
            Total Cart Price
            <span className='font-bold pl-10'>{totalCartPrice} EGP</span>
          </h6>
      ...
      <button onClick={deleteUserCart} className='lg:ms-10 font-medium bg-red-600 text-white p-2 m-3 rounded-md'>
        Clear user cart
      </button>
    </div>
  </>
